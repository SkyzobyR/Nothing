...
const nyoutube = ('© Nothing>_\nYoutube :\nhttps://bit.ly/skyzoNation')  //ubah di config biar ngk emror
...
const sendStickerFromUrl = async(to, url) => {
      ...
      //Resize
         const reSize = async(buffer, ukur1, ukur2) => {
             ...
             //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: await reSize(thumb, 100, 100), surface: 200, message: `${ytname}`, orderTitle: 'nothing', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
//PEMBATAS ADMIN & OWNER=======================================
  ...
  papah.sendMessage(m.chat, buttonMessage, {quoted: fkontak})
            ...
            let ments = [me]
            let buttons = [{ buttonId: 'rules', buttonText: { displayText: 'ʀᴜʟᴇꜱ' }, type: 1 }]
...
let buttons = [{ buttonId: 'donasi', buttonText: { displayText: 'ꜱᴇᴡᴀ' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'ʀᴜʟᴇꜱ' }, type: 1 }]
...
encmedia = await papah.sendImageAsSticker(m.chat, wifegerakx, m, { packname: "Made By", author: "SkyzobyR", })
await fs.unlinkSync(encmedia)
}
break
case'doge':
...
papah.sendMessage(m.chat, { caption: 'Kamu bisa mengubahnya menjadi Vidio Tanpa Watermark atau Audio, pencet tombol dibawah untuk mengubahnya!', video: { url: data.watermark }, buttons: buttons, footer: `© Nothing>_`, mentions: [sender] })
})
}
break
            case 'tiktoknowm':{
...
Nothing>_ merupakan sebuah Robot WhatsApp yang diprogram untuk melakukan perintah tertentu secara otomatis.
...
`
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'ʟɪꜱᴛ ᴍᴇɴᴜ' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'ꜱᴇᴡᴀ' }, type: 1 }]
...
-Creator :  @${ownernya.split('@')[0]}\n-Lu : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}\n- :  @${qontak.split('@')[0]}\n- :  @${dana.split('@')[0]}\n- :  @${shopeeotp.split('@')[0]}\n- :  @${shopee.split('@')[0]}\n- :  @${tokopedia.split('@')[0]}\n- :  @${smartfrend.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${facebook.split('@')[0]}\n- :  @${pasarpolis.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${kominfo.split('@')[0]}\n- :  @${alfamart.split('@')[0]}`
            ...
            let buttons = [
                        { buttonId: 'allmenu', buttonText: { displayText: 'ʟɪꜱᴛ ᴍᴇɴᴜ' }, type: 1 }
                    ]
                    await papah.sendButtonText(m.chat, buttons, jawab, papah.user.name, m, {mentions: ments})
            }
            break
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'ʟɪꜱᴛ ᴍᴇɴᴜ' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'ʀᴜʟᴇꜱ' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'ᴅᴏɴᴀꜱɪ' }, type: 1 }]
            let buttonMessage = {
...
│
╰─────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: 'ʟɪꜱᴛ ᴍᴇɴᴜ' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'ᴅᴏɴᴀꜱɪ' }, type: 1 }]
...
`
                let buttons = [
                    {buttonId: `allmenu`, buttonText: {displayText: 'ʟɪꜱᴛ ᴍᴇɴᴜ'}, type: 1},
		    {buttonId: `donasi`, buttonText: {displayText: 'ᴅᴏɴᴀꜱɪ'}, type: 1}
                ]
                let buttonMessage = {
                    text: anu,
                    footer: botname,
...
Eren
User Nothing>_`
                let buttons = [{ buttonId: 'donasi', buttonText: { displayText: 'ᴅᴏɴᴀꜱɪ' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'ʀᴜʟᴇꜱ' }, type: 1 }]
